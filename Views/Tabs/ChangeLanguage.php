        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <?php echo wp_nonce_field( 'languageSettings'); ?>
                ...
                <table class="table table-striped table-bordered table-primary">
                    ...
                    <tr>
                        <th colspan=<?php echo  count($months); ?> class="text-center">Translate month name in your own language</th>
                    </tr>
                    <tr>
                        <?php
                ...
                <table class="table table-striped table-bordered table-primary">
                    <tr>
                        <th colspan="9" class="text-center">Other table headings in your language</th>
                    </tr>
                    <tr>
                ...
                <table class="table table-striped table-bordered table-primary">
                    <tr>
                        <th colspan="10" class="text-center">Numbers in your language</th>
                    </tr>
                    <tr>
                        <?php $numbers = $timetable->getLocalNumbers();
                        foreach ($numbers as $key => $val) { ?>
                            <th class="text-center"><?php echo esc_html($key) ?></th>
                        <?php } ?>
                    </tr>
                    <tr>
